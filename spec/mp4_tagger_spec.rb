...
describe EasyTag::MP4Tagger do
  ...
  context 'when containing no tags' do
    it 'should return the proper response' do
      ...
      :genre, :lyrics, :date, :encoded_by, :group,
      :mood, :copyright, :subtitle, :disc_subtitle, :media, :label,
      :composer, :remixer, :lyricist, :asin, :barcode, :catalog_number,
      ...
      [:comments, :musicbrainz_artist_id, :musicbrainz_release_type].each do |attr|
